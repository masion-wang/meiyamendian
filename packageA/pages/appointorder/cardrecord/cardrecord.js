import {
  getUserNumCardRcds
} from "../../../../route/index/appointorder/cardrecord";
...
Page({
  ...
  loadMore() {
    ...
    if (!isend) {
      console.log("加载更多");
      getUserNumCardRcds(params).then((res) => {
  ...
  gotoprojectalarm: function (e) {
    console.log("333", e);
    let uid = e.currentTarget.dataset.id;
    wx.navigateTo({
      url: `/packageA/pages/appointorder/projectalarm/projectalarm?uid=${uid}`,
    });
  },
});